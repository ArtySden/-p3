  ...
  return (
    <section className="page-shell fade-in">
      <div className="two-column-grid">
        <form onSubmit={enviar} className="bg-white rounded-[32px] shadow-2xl responsive-card" noValidate>
          <p className="font-black text-purple-700">Formulario</p>
          <h2 className="responsive-subtitle font-black text-gray-950">Contáctanos</h2>
          ...
          <div className="mt-6 grid gap-5">
            ...
            <div>
              ...
              <textarea id="mensaje" name="mensaje" rows="5" value={formulario.mensaje} onChange={actualizar} className="focus-ring mt-2 w-full border border-gray-300 rounded-xl px-4 py-3 resize-y min-h-36" aria-invalid={!!errores.mensaje} aria-describedby="errorMensaje"></textarea>
          ...
          <button disabled={enviando} className="focus-ring touch-target mt-6 w-full bg-purple-700 hover:bg-purple-800 disabled:bg-gray-400 text-white rounded-xl px-6 py-3 font-black transition">
            {enviando ? "Enviando..." : "Enviar mensaje"}
          </button>
        </form>

        <aside className="space-y-6">
          <div className="bg-gray-950 text-white rounded-[32px] shadow-2xl responsive-card">
          ...
          <div className="bg-white rounded-[32px] shadow-2xl responsive-card">
            ...
            <div className="mt-4 rounded-3xl overflow-hidden border border-gray-200 map-frame">
              <iframe title="Mapa de ubicación UniGo" src="https://maps.google.com/maps?q=-13.1631,-74.2236&z=16&output=embed" width="100%" height="100%" className="block min-h-[16rem] sm:min-h-[20rem]" style={{ border: 0 }} loading="lazy" allowFullScreen></iframe>
            </div>
          </div>
        </aside>
      </div>
